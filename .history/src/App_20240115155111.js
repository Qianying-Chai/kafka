...
import CreateTopics from "./pages/Taas/Topics/CreateTopics.jsx";
        ...
        <Layout>
          ...
          >
            <Routes>
              ...
              />
              <Route
                path={`kafka/${categoryConstants.TOPICS.toLowerCase()}/${categoryConstants.CREATE_TOPICS.toUpperCase()}`}
